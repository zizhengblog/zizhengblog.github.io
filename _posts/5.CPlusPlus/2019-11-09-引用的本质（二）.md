...
<!-- ************************************************ -->
## <a id="content1"></a>汇编补充

<!-- ************************************************ -->
## <a id="content2"></a>通过汇编分析指针
```
...
void referenceWithOtherType(void){
    ...
    int * const & ref4 = array;//array是数组的首地址是一个常量
    
    ref3[1] = 4;
    cout<<"ref3[1] = "<<ref3[1]<<endl;
    cout<<"array[1] = "<<array[1]<<endl;
    
    //int &array4[3] = {age,age,age};//不存在引用数组
...
void constReferenceTemp(void){
    ...
    cout<<"refff = "<<refff<<endl;//30
    
    
    //long & refff = age;
    const long & reffff = age;//当常引用指向了不同类型的数据时，会产生临时变量,所以修改age不会更改reffff的值
    cout<<"reffff = "<<reffff<<endl;//30
    age = 40;
