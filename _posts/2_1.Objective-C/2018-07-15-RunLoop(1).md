...
<span style="color:red;font-weight:bold">点击屏幕 - springboard进程捕获点击事件 - 通过端口传递source1给当前进程唤醒runloop(app通过监听端口来接收source1) - 在处理source1的回调中触发source0 -  source0再触发_UIApplicationHandleEventQueue() - UIWindow - SubView - SubView</span>
