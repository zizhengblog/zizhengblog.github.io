...
<!-- ************************************************ -->
## <a id="content1">shell脚本</a>

写在XYDebugConfig.xcconfig文件中的内容

```shell
#include "Pods/Target Support Files/Pods-XYApp/Pods-XYApp.debug.xcconfig"

VERBOSE_SCRIPT_LOGGING = -v

MACHO_DIR=${BUILD_DIR}/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)/${WRAPPER_NAME}
MACHO_PATH=${MACHO_DIR}/${PRODUCT_NAME}
CMD=nm -pa ${MACHO_PATH};ls -l ${MACHO_DIR}
TTY=/dev/ttys001
